...
public class StarRocksRangePartitioner extends Partitioner {
    ...
    public int numPartitions() {
        ...
        if (PartitionType.UNPARTITIONED.is(partitionInfo.getPartitionType())) {
            return 1;
        }
        return partitionInfo.getPartitions().size();
    }
    ...
    public int getPartition(Object var1) {
        ...
        if (PartitionType.RANGE.not(partitionInfo.getPartitionType())) {
            return -1;
        }
