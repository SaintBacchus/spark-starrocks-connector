...
import com.starrocks.connector.spark.read.StarRocksWithoutCatalogPartitionReader
...
private[spark] abstract class AbstractStarRocksRDDIterator[T](context: TaskContext,
  ...
  lazy val decoder = new StarRocksWithoutCatalogPartitionReader(partition, partition.settings())
