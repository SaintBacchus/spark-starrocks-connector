...
public class TestRpcRowBatch {
    ...
    public void testRowBatch() throws Exception {
        ...
        Assertions.assertTrue(exception.getMessage().contains("Row offset"));
    }
    ...
    public void testBinary() throws Exception {
        ...
        Assertions.assertTrue(exception.getMessage().startsWith("Row offset"));
    }
    ...
    public void testDecimalV2() throws Exception {
        ...
        Assertions.assertTrue(rpcRowBatch.hasNext());
        List<Object> actualRow0 = rpcRowBatch.next();
        Assertions.assertEquals(Decimal.apply(12340000000L, 11, 9), actualRow0.get(0));

        Assertions.assertTrue(rpcRowBatch.hasNext());
        List<Object> actualRow1 = rpcRowBatch.next();
        Assertions.assertEquals(Decimal.apply(88880000000L, 11, 9), actualRow1.get(0));

        Assertions.assertTrue(rpcRowBatch.hasNext());
        List<Object> actualRow2 = rpcRowBatch.next();
        Assertions.assertEquals(Decimal.apply(10000000000L, 11, 9), actualRow2.get(0));
    ...
    public void testFastDecimal() throws Exception {
        ...
        Assertions.assertTrue(rpcRowBatch.hasNext());
        List<Object> actualRow0 = rpcRowBatch.next();
        Assertions.assertEquals(Decimal.apply(12340000L, 17, 6), actualRow0.get(0));

        Assertions.assertTrue(rpcRowBatch.hasNext());
        List<Object> actualRow1 = rpcRowBatch.next();
        Assertions.assertEquals(Decimal.apply(88880000L, 17, 6), actualRow1.get(0));

        Assertions.assertTrue(rpcRowBatch.hasNext());
        List<Object> actualRow2 = rpcRowBatch.next();
        Assertions.assertEquals(Decimal.apply(10000000L, 17, 6), actualRow2.get(0));
